...
def responsa_chatbot_appears(webdriver, datasets):
  ...
  @print_timing("selenium_customer_responsa_chatbot_appears")
  def measure():
    page.go_to_url(f"{JSM_SETTINGS.server_url}/servicedesk/customer/portal/{JSM_SETTINGS.responsa_service_desk_id}")
    page.wait_until_visible((By.ID, f"res_root_{JSM_SETTINGS.responsa_chatbot_id}"))
